    ...
    public partial class InitMig : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChequeStatuts", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChequierStatuts", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommandeEtape", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmballageCommandeStauts", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Numero = table.Column<string>(type: "varchar(100)", unicode: false, maxLength: 100, nullable: false),
                    isActif = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    ChequeStatutId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NombreTentativeLivraison = table.Column<int>(type: "int", nullable: false),
                    CollaborateurId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Livraison", "Lac2", "KoliZen@mail.com", "2025", "Tunis", "0000000/A/A/A/000", "KoliZen", "Fedi", "aa", "L/05/500/m", "Livraison", "00000000", "Tunis" });
